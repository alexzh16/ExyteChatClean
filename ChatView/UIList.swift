...
struct UIList<MessageContent: View, InputView: View>: UIViewRepresentable {
   ...
   func updateUIView(_ tableView: UITableView, context: Context) {
      ...
      updatesQueue.async {
         ...
         debugPrint("\(#function) \(#line) 1 updateUIView sections:", "\n")
         debugPrint("\(#function) \(#line) whole previous:\n", formatSections(prevSections), "\n")
         debugPrint("\(#function) \(#line) whole appliedDeletes:\n", formatSections(appliedDeletes), "\n")
         debugPrint("\(#function) \(#line) whole appliedDeletesSwapsAndEdits:\n", formatSections(appliedDeletesSwapsAndEdits), "\n")
         debugPrint("\(#function) \(#line) whole final sections:\n", formatSections(sections), "\n")
         
         debugPrint("\(#function) \(#line) operations delete:\n", deleteOperations)
         debugPrint("\(#function) \(#line) operations swap:\n", swapOperations)
         debugPrint("\(#function) \(#line) operations edit:\n", editOperations)
         debugPrint("\(#function) \(#line) operations insert:\n", insertOperations)
         
         DispatchQueue.main.async {
            tableView.performBatchUpdates {
               // step 2
               // delete sections and rows if necessary
               debugPrint("\(#function) \(#line) 2 apply delete")
         ...
         DispatchQueue.main.async {
            tableView.performBatchUpdates {
               ...
               debugPrint("\(#function) \(#line) 3 apply swaps")
               ...
               tableSemaphore.signal()
               debugPrint("\(#function) \(#line) 3 finished swaps")
            }
         }
         tableSemaphore.wait()
         ...
         DispatchQueue.main.async {
            ...
            tableView.performBatchUpdates {
               ...
               debugPrint("\(#function) \(#line) 4 apply edits")
               ...
               debugPrint("\(#function) \(#line) 4 finished edits")
            }
         }
         tableSemaphore.wait()
         ...
         if isScrolledToBottom || isScrolledToTop {
            DispatchQueue.main.sync {
               ...
               debugPrint("\(#function) \(#line) 5 apply inserts")
               context.coordinator.sections = sections
